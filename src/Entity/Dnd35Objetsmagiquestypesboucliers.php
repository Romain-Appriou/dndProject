...
/**
 * Dnd35Objetsmagiquestypesboucliers
 *
 * @ORM\Table(name="dnd35_objetsMagiquesTypesBoucliers")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesTypesBoucliersRepository")
 */
class Dnd35Objetsmagiquestypesboucliers
{
    /**
     * @var int
     *

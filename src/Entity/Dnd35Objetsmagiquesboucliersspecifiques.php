...
/**
 * Dnd35Objetsmagiquesboucliersspecifiques
 *
 * @ORM\Table(name="dnd35_objetsMagiquesBoucliersSpecifiques")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesBoucliersSpecifiquesRepository")
 */
class Dnd35Objetsmagiquesboucliersspecifiques
{
    /**
     * @var int
     *

...
/**
 * Dnd35Objetsmagiquesarmes
 *
 * @ORM\Table(name="dnd35_objetsMagiquesArmes")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesArmesRepository")
 */
class Dnd35Objetsmagiquesarmes
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="bonus", type="string", length=50, nullable=false)
     */
    private $bonus;
     ...
     * @var int|null
     *
     * @ORM\Column(name="prixBase", type="integer", nullable=true)
     */
    private $prixbase;
    ...
    public function setPrixbase(?int $prixbase): self
    {

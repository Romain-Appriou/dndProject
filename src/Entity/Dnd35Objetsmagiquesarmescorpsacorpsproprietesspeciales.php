...
/**
 * Dnd35Objetsmagiquesarmescorpsacorpsproprietesspeciales
 *
 * @ORM\Table(name="dnd35_objetsMagiquesArmesCorpsACorpsProprietesSpeciales")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesArmesCorpsACorpsProprietesSpecialesRepository")
 */
class Dnd35Objetsmagiquesarmescorpsacorpsproprietesspeciales
{
    /**
     * @var int
     *

...
/**
 * Dnd35Objetsmagiquesboucliersproprietesspeciales
 *
 * @ORM\Table(name="dnd35_objetsMagiquesBoucliersProprietesSpeciales")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesBoucliersProprietsSpecialesRepository")
 */
class Dnd35Objetsmagiquesboucliersproprietesspeciales
{
    /**
     * @var int
     *
     ...
     * @var int|null
     *
     * @ORM\Column(name="modificateurPrix", type="integer", nullable=true)
     */
    private $modificateurprix;
    ...
    public function getModificateurprix(): ?int
    {
        return $this->modificateurprix;
    }

    public function setModificateurprix(?int $modificateurprix): self
    {

...
/**
 * Dnd35Objetsmagiquestypesparchemins
 *
 * @ORM\Table(name="dnd35_objetsMagiquesTypesParchemins")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesTypesParcheminsRepository")
 */
class Dnd35Objetsmagiquestypesparchemins
{
    /**
     * @var int
     *

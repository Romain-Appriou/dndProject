...
/**
 * Dnd35Objetsmagiquesarmesdistanceproprietesspeciales
 *
 * @ORM\Table(name="dnd35_objetsMagiquesArmesDistanceProprietesSpeciales")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesArmesDistanceProprietesSpecialesRepository")
 */
class Dnd35Objetsmagiquesarmesdistanceproprietesspeciales
{
    /**
     * @var int
     *

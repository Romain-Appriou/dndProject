...
/**
 * Dnd35Objetsmagiquesarmuresspecifiques
 *
 * @ORM\Table(name="dnd35_objetsMagiquesArmuresSpecifiques")
 * @ORM\Entity(repositoryClass="App\Repository\ObjetsMagiquesArmuresSpecifiquesRepository")
 */
class Dnd35Objetsmagiquesarmuresspecifiques
{
    /**
     * @var int
     *

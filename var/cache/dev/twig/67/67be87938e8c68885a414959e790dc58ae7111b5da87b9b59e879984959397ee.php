...
class __TwigTemplate_20333ff13e54e191cd778ea7044b0a6a13e3f9702256dfdbc3e02cd63d08e751 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["dnd35_races"]) || array_key_exists("dnd35_races", $context) ? $context["dnd35_races"] : (function () { throw new RuntimeError('Variable "dnd35_races" does not exist.', 15, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dnd35_race"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_races_show", ["id" => twig_get_attribute($this->env, $this->source, $context["dnd35_race"], "id", [], "any", false, false, false, 17)]), "html", null, true);
            echo "\"><button>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["dnd35_race"], "nom", [], "any", false, false, false, 17), "html", null, true);
            echo "</button></a></td>
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for dnd35_race in dnd35_races %}
            <tr>
                <td><a href=\"{{ path('app_races_show', {'id': dnd35_race.id}) }}\"><button>{{ dnd35_race.nom }}</button></a></td>
